...
echo "---------------------------------------------------------"
dotnet sln $PROJECT_NAME.sln add src/**/*.csproj
dotnet sln $PROJECT_NAME.sln add tests/**/*.csproj
...
# dotnet add src/$MyProjectName.Core/$MyProjectName.Core.csproj package Microsoft.EntityFrameworkCore.MySql --version 3.0.0 --package-directory packages
# dotnet add src/$MyProjectName.Core/$MyProjectName.Core.csproj package Microsoft.EntityFrameworkCore.Sqlite --version 3.0.0 --package-directory packages
# dotnet add src/$MyProjectName.Core/$MyProjectName.Core.csproj package Dapper --version 2.0.30 --package-directory packages
